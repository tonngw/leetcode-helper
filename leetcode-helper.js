...
(function () {
	...
	generateSolutionBtn.style.height = "20px";
	generateSolutionBtn.style.align = "center";
    generateSolutionBtn.style.marginLeft = "10px";
    generateSolutionBtn.style.marginTop = "15px";

    // waitForKeyElements 等待页面渲染完成后执行，但waitForKeyElements.js 在油猴中不能使用，本地测试没问题
    // waitForKeyElements(description, function () {
    //     var x = document.getElementsByClassName("css-10c1h40-Title eugt34i1")[0];
    //     x.appendChild(copyBtn);
    //     x.appendChild(generateSolutionBtn);
    // });
    ...
    function handleHtml(html) {
        ...
        let target = $("div[class='notranslate']");
